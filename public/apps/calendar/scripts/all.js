const AVAILABLE_WEEK_DAYS = ['Domingo', 'Lunes', 'Martes', 'Miercoles', 'Juevez', 'Viernes', 'Sabado'];
...
// App methods
    ...
    drawEvents() {
        ...
        let eventList = this.eventList[calendar.active.formatted] || ['No hay pendientes'];
        let eventTemplate = "";
    ...
    drawMonths() {
        let availableMonths = ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"];
        let monthTemplate = "";
        let calendar = this.getCalendar();
